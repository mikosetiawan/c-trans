...
<head>
    ...
    <title>Driver | Dash C-Trans</title>
...
<body>
    ...
    ?>
        ...
        <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none; background-color: #FF6000;" id="mySidebar">
            ...
            <a href="../../controller/page?page=Driver" class="w3-bar-item px-3 py-3 active-sidebar-active text-white" style="text-decoration: none;">Driver</a>
        ...
        <div class="w3-container">
            <div class="row my-3">
                <div class="col-lg-12 shadow-lg px-5 py-5 rounded-4">
                    <div class="my-4">
                        <span class="title-form">Form Input Driver</span>
                    </div>
                    <form action="../../assets/php/act_driver.php" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="namaDriver" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Place of birth</label>
                                    <input name="tempatLahir" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Date of birth</label>
                                    <input name="tglLahir" type="date" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">No. Telephone/Whatsapp</label>
                                    <input name="noTlp" type="number" class="form-control" placeholder="+62" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">SIM Type</label>
                                    <select name="jenisSIM" id="" class="form-select" required>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Full Address</label>
                                    <textarea name="alamat" class="form-control" id="" cols="30" rows="8" placeholder="Jl." required></textarea>
                                </div>
                                <div class="mb-3">
