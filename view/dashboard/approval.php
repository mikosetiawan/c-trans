...
<head>
    ...
    <title>Approval | Dash C-Trans</title>
...
<body>
    ...
    ?>
        ...
        <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none; background-color: #FF6000;" id="mySidebar">
            ...
            <a href="../../controller/page?page=Approval" class="w3-bar-item px-3 py-3 active-sidebar-active text-white" style="text-decoration: none;">Approval</a>
        ...
        <div class="w3-container">
            <div class="row my-3">
                <div class="col-lg-12 shadow-lg px-5 py-5 rounded-4">
                    <div class="my-4">
                        <span class="title-form">Form Input Approval</span>
                    </div>

                    <form action="../../assets/php/act_approval.php" method="post">
                        <div class="row">

                            <div class="col-lg-6">
                                
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Approval Name</label>
                                    <input name="namaApproval" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Position</label>
