        ...
        <div class="w3-container">
            <div class="row my-3">
                <div class="col-lg-12 shadow-lg px-5 py-5 rounded-4">
                    <div class="my-4">
                        <span class="title-form">Approved / ACC</span>
                    </div>
                    ...
                    <div class="row">
                        ...
                        $data = mysqli_query($conn, "SELECT * from tb_pemesanan WHERE namaApproval='$_SESSION[username]' OR namaApproval2='$_SESSION[username]'");
                        foreach ($data as $row) {
                        ?>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 shadow px-3 py-3">
                                    ...
                                    ?>
                                        ...
                                        <form action="../../assets/php/update_acc.php" method="POST">
                                            <div class="mb-3">
                                                <input name="idPemesanan" type="text" value="<?= $row['idPemesanan']; ?>" hidden>
                                                <button name="status_acc" type="submit" value="2" class="btn-approved">Yes, ACC</button>
                                            </div>
                                            <div class="mb-3">
                                                <button name="status_acc" type="submit" class="btn-not-approved" value="3">Not In ACC</button>
                                            </div>
                                        </form>

                                    <?php

                                    } else if ($row['status_acc'] == 1) {
                                    ?>
                                        <form action="../../assets/php/update_acc.php" method="POST">
                                            <div class="mb-3">
                                                <input name="idPemesanan" type="text" value="<?= $row['idPemesanan']; ?>" hidden>
