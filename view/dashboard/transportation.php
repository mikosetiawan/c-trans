...
<head>
    ...
    <title>Transportation | Dash C-Trans</title>
...
<body>
    ...
    ?>
        ...
        <div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none; background-color: #FF6000;" id="mySidebar">
            ...
            <a href="../../controller/page?page=Transportation" class="w3-bar-item px-3 py-3 active-sidebar-active text-white" style="text-decoration: none;">Transportation</a>
        ...
        <div class="w3-container">
            <div class="row my-3">
                <div class="col-lg-12 shadow-lg px-5 py-5 rounded-4">
                    <div class="my-4">
                        <span class="title-form">Form Input Transportation</span>
                    </div>

                    <form action="../../assets/php/act_transportation.php" method="post">
                        <div class="row">
                            <div class="col-lg-6">

                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Trans Name</label>
                                    <input name="namaKendaraan" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Trans Type</label>
                                    <input name="jenisKendaraan" type="Mobil" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Flat No</label>
                                    <input name="flatNo" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Trans Status</label>
                                    <input name="statusKendaraan" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Trans Services</label>
                                    <input name="serviceKendaraan" type="date" class="form-control" required>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-8 px-3 py-3" style="background-color: #FF7759; border-radius: 25px 0px 0px 0px;">
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <h1 class="bi bi-exclamation-triangle-fill text-white" style="font-size: 60px;"></h1>
                                        </div>
                                        <div class="col-lg-7">
                                            <span style="font-weight:500; font-size:25px;" class="text-white">Warning !</span>
                                            <p class="text-white">Appropriate vehicle service
                                                with slow time
                                                inputted!</p>
                                        </div>
                                    </div>
