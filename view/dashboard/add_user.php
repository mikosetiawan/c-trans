...
<head>
    ...
    <title>Add User/Admin | Dash C-Trans</title>
        ...
        <div class="w3-container">
            <div class="row my-3">
                <div class="col-lg-12 shadow-lg px-5 py-5 rounded-4">
                    <div class="my-4">
                        <span class="title-form">Form ADD User / Admin</span>
                    </div>

                    <form action="../../assets/php/act_addUser.php" method="post">
                        <div class="row">

                            <div class="col-lg-6">

                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Username</label>
                                    <input name="username" type="text" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Password</label>
                                    <input name="password" type="password" class="form-control" required>
                                </div>
                                <div class="mb-3">
                                    <label for="" style="color: #FF6000;">Status</label>
